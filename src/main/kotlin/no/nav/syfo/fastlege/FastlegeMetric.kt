...
val COUNT_CALL_CALL_FASTLEGER_CACHE_HIT: Counter = builder(CALL_FASTLEGER_CACHE_HIT)
    .description("Counts the number of cache hits when looking up fastleger")
    .register(METRICS_REGISTRY)

val COUNT_CALL_CALL_FASTLEGER_CACHE_MISS: Counter = builder(CALL_FASTLEGER_CACHE_MISS)
