...
class STSClientConfig {
    ...
    companion object {
        ...
        protected fun configureStsRequestSamlToken(client: Client, cacheTokenInEndpoint: Boolean) {
        ...
        protected fun configureStsWithPolicyForClient(
            stsClient: STSClient,
            client: Client,
         ...
         * @return
         */
        protected fun createCustomSTSClient(bus: Bus): STSClient {
            return STSClientWSTrust13and14(bus)
        }

        protected fun configureSTSClient(stsClient: STSClient, location: String?, username: String,
        ...
        protected fun setEndpointPolicyReference(
            client: Client,
            uri: String
        ) {
